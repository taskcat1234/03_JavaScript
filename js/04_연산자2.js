/* 
  ...
  consile.log(`num에 저장된 값은 ${num} 입니다.`);
...
function check1(){
  ...
  console.log("str1 == str3 :", str1 == str2); //false
...
function oddEvenCHeck(){
  ...
  // 짝수 == 2의 배수 == 2로 나줬을때 나머지가 0인 수
  // 홀수 == 2의 배수 -1 == 2로 나줬을때 나머지가 0인 수
...
/* AND 연산자 확인 */
function andCheck(){
  // 104는 100 이상의 숫자 이면서 짝수 인가?
  const bool1 = (104 >= 100) && (104 % 2 === 0);
  console.log(`104는 100 이상의 숫자 이면서 짝수 인가? ${bool1}`);
  // (104 >= 100) && (104 % 2 === 0)
  // 50은 70 이하의 숫자이고 4의 배수가 맞는가?
  const bool2 = (50 <= 50) && (50 % 4 === 0);
...
function orCheck(){
  ...
  const age = 20;
  const name = "홍길동";
  const bool2 = (name == "홍길동") || (age > 18);
  console.log(`결과 2 : ${bool2}`)
  // 국어 또는 영어 점수가 40점 미만 이거나
  // 평균이 60점 미만인가?
  const kor = 50;
  const eng = 75;
